...
public static aspect UtilPreconditionChecking_Extractor$159f654e_0260_4e8e_9f4e_5de05715d1df{
  before(): (execution( * br.edu.imd.edb.application.Extractor..*+.*(..))
          || execution(br.edu.imd.edb.application.Extractor..*+.new(..))
          || execution( * br.edu.imd.edb.application.Extractor+.*(..))
          || execution(br.edu.imd.edb.application.Extractor+.new(..))){
...
public static aspect UtilPreconditionChecking_Heap$0a4978a7_f7e1_466e_852e_af42d2fa7977{
  before(): (execution( * br.edu.imd.edb.heap.Heap..*+.*(..))
          || execution(br.edu.imd.edb.heap.Heap..*+.new(..))
          || execution( * br.edu.imd.edb.heap.Heap+.*(..))
          || execution(br.edu.imd.edb.heap.Heap+.new(..))){
    JMLChecker.hasAnyThrownPrecondition();
...
public static aspect UtilPreconditionChecking_Node$99db8672_3a57_4142_aac3_0da1cab9608b{
  before(): (execution( * br.edu.imd.edb.tree.Node..*+.*(..))
          || execution(br.edu.imd.edb.tree.Node..*+.new(..))
          || execution( * br.edu.imd.edb.tree.Node+.*(..))
          || execution(br.edu.imd.edb.tree.Node+.new(..))){
    JMLChecker.hasAnyThrownPrecondition();
